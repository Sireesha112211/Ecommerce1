...
public class tillTwenty_six extends Base {
	tillFifteen u3;
	...
	public void compareDeliveryAddressWithRegisteredAddress() {
		...
		delivery_address.add("789");
		delivery_address.add("ExcelR");
		delivery_address.add("Nivas Building");
		delivery_address.add(" Apartment");
		delivery_address.add("Pune 411036");
		delivery_address.add("India");
		delivery_address.add("7788996655");
		List<String>registered_address=new ArrayList<String>();
		registered_address.add("789");
		registered_address.add("ExcelR");
		registered_address.add("Nivas Building");
		registered_address.add(" Apartment");
		registered_address.add("Pune 411036");
		registered_address.add("India");
		registered_address.add("7788996655");
	...
	public void compareBillingAddressWithRegisteredAddress() {
		...
		billing_address.add("789");
		billing_address.add("ExcelR");
		billing_address.add("Nivas Building");
		billing_address.add("Apartment");
		billing_address.add("Pune 411036");
		billing_address.add("India");
		billing_address.add("7788996655");
		List<String>registered_address=new ArrayList<String>();
		registered_address.add("789");
		registered_address.add("ExcelR");
		registered_address.add("Nivas Building");
